...
class Test_hackman(unittest.TestCase):
    ...
    def test_for_incorrect_input_from_user(self):
        ...
        demo_get_input = hackman.validate_user_input(demo_invalid_input)
    ...
    def test_for_correct_input_from_user(self):
        ...
        demo_get_input = hackman.validate_user_input(demo_correct_input)
    ...
    def test_valid_guess(self):
        ...
        guess = "12345"
        actual_code = "12345"
        check_guess_is_equal_to_pin = hackman.valid_guess(guess, actual_code)
